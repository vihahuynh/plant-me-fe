...
const Account = () => {
    ...
    const onSaveAccount = async (values) => {
        try {
            ...
            clearTimeout(delay)
            dispatch(authenticationActions.update({ user: { ...updatedAccount.data, token: authen?.user?.token } }))
            dispatch(alertActions.updateMessage({ message: "Update account information successfully!", type: "info" }))
                                    ...
                                    {isEditAvatar ? <>
                                        ...
                                        : <div className={styles.avatar}>
                                            <img
                                                ...
                                                alt="Avatar"
                                            />
                                            <TbEdit className={styles.editAvatarIcon} onClick={onEditAvatar} />
                                        </div>
                                    }
