      ...
      <div className={styles.container}>
        ...
        <section className={styles.history}>
          ...
          <p>
            ...
            We have formed a proudly Made in India ecosystem that grows with
            each passing day.
          </p>
        </section>
        <img
        ...
        <section className={styles.actions}>
          <div>
            ...
            <p>
              ...
              when they reach you, they spread the same joy in your lives.
            </p>
          </div>
          <div>
            <h1>How we do it</h1>
            <p>
              ...
              own plants in state-of-the-art polyhouses and greenhouses spread
        ...
        <section className={styles.people}>
          ...
          <p>
            ...
            superheroes, and the best worker bees who ensure that everything
            moves ahead at the right pace.
          </p>
        </section>
      </div>
    </Wrapper>
